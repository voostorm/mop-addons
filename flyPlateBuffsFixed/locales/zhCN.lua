...
Legion default = 60. Old default = 40.]=] ] =
  [=[更改CVars参数 "nameplateMaxDistance".
...
L['Sets CVars "nameplateOtherTopInset" and "nameplateOtherBottomInset" to -1'] =
  '将CVars 参数\\"nameplateOtherTopInset\\"和\\"nameplateOtherBottomInset\\"设定为-1'
L["Show"] = "显示"
L["Show buffs"] = "显示buff"
