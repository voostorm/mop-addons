...
elseif locale == "ruRU" then -- translated by Termoshpuntik
	...
	L["Snare"]       = "Замедление"
	L["Immune"]      = "Невосприимчивый"
	L["ImmuneSpell"] = "Невоспр. к спеллам"
	L["ImmunePhysical"] = "Невоспр. к физурону"
	L["Other"]       = "Другой"
	L["PvE"]         = "PvE"
	L["player"] = "Игрок"
	L["pet"]    = "Питомец игрока"
	L["target"] = "Цель"
	...
	L["g:"] = "g:"
	L["b:"] = "b:"
	L["Unit Configuration"] = "Конфигурация юнита"
	L["Enabled"] = "Включено"
	L["DisableInBG"] = "Выключить на поле боя"
	L["DisableInArena"] = "Выключить на арене"
	L["DisableInRaid"] = "Выключить в рейде"
	L["DisableInterrupts"] = "Выключить прерывания для этого юнита"
	L["ShowNPCInterrupts"] = "Также показывать прерывания для НПЦ"
	L["DisablePlayerTargetTarget"] = "Выключить когда юнит это Игрок"
	L["DisableTargetTargetTarget"] = "Выключить когда юнит это Цель"
	L["DisablePlayerTargetPlayerTargetTarget"] = "Выключить когда юнит и цель это Игрок"
	L["DisableTargetDeadTargetTarget"] = "Выключить когда цель мертва"
	L["DuplicatePlayerPortrait"] = "Дублировать иконку на портрете игрока"
	L["EnabledPartyPlayerIcon"] = "Включить иконку группы для игрока"
	L["DisableFocusFocusTarget"] = "Выключить когда юнит это Фокус"
	L["DisablePlayerFocusPlayerFocusTarget"] = "Выключить когда юнит и Фокус это игрок"
	L["DisableFocusDeadFocusTarget"] = "Выключить когда цель в Фокусе мертва"
	L["EnableElementalSchoolMiniIcon"] = "Включить иконку Элементов для прерывания"
	L["EnableChaosSchoolMiniIcon"] = "Включить иконку Хаоса для прерывания"
	L["UseSpellInsteadSchoolMiniIcon"] = "Использовать иконку заклинания вместо школы для прерывания"
	L["SwipeCooldownOpacity"] = "Передвинуть прозрачность кулдауна"
	L["Anchor"] = "Якорь"
	L["anchor:"] = "Якорь:"
	L["icon anchor:"] = "Якорь значка:"
	L["frame strata:"] = "Каркас:"
	L["frame level:"] = "Уровень:"
	L["Anchored to:"] = "Прикреплен к:"
	L["AnchorPositionDropDownAnchorLabel"] = "якорь элемента: "
	L["CategoriesEnabledLabel"] = "Включить для следующих категорий: (|cff00ff00[F]|r для дружественной единицы, |cffff0000[E]|r враждебная единица, |cff134d56[B]|r полезная аура, \n|cff543f16[D]|r вредная аура):"
	L["AdditionalOptionsLabel"] = "Дополнительные параметры:"
	L["InterruptBackgroundOpacity"] = "Прозрачность фона прерывания"
	L["InterruptBackgroundColor"] = "Цвет фона прерывания"
	L["InterruptMiniIconsOpacity"] = "Прозрачность иконки прерывания"
	L["CatFriendly"] = "|cff00ff00[F]|r"
	L["CatEnemy"] = "|cffff0000[E]|r"
	L["CatFriendlyBuff"] = "|cff00ff00[F]|r|cff134d56[B]|r"
	L["CatFriendlyDebuff"] = "|cff00ff00[F]|r|cff543f16[D]|r"
	...
	L["Disable Blizzard Countdown"] = "Отключить счетчик Blizzard"
	L["Disable Get Extra Aura Duration Information"] = "Отключить получение дополнительной информации об аурах"
	L["Disable Get Enemies Buff Information"] = "Отключить получение информации о бафах врагов"
	L["DisableLossOfControlCooldownText"] = "Отключить счетчик длительности для эффектов потери контроля"
	L["NeedsReload"] = "Необходима перезагрузка интерфейса"
	L["Priority"] = "Приоритет"
	L["PriorityDescription"] = "Установить приоритет для каждого заклинания категорий. Более высокие значения имеют приоритет.\n Установка значения в 0 отключает категорию."
	L["LoseControl reset."] = "Сброс настроек LoseControl."
	L["Yes"] = "Да"
	L["No"] = "Нет"
	L["Yes (recomended)"] = "Да (рекомендуется)"
	L["BlizzardLossOfControl"] = "Уведомления о потере контроля Blizzard"
	L["BlizzardLossOfControlCombatWarning"] = "Не могу изменить параметры во время битвы"
	L["BlizzardLossOfControlDescription"] = "Контроль переменных CVars Blizzard для включения/выключения предупреждений о контроле по-умолчанию.\nРекомендуется выключить предупреждения и использовать предупреждения аддона"
	L["BlizzardLossOfControlGeneralTextUnchecked"] = "Включить уведомления Blizzard о потере контроля"
	L["BlizzardLossOfControlGeneralTextChecked"] = "Включить уведомления Blizzard о потере контроля (рекомендация: выключите данный параметр)"
	L["Off"] = "Выключить"
	L["Only Alert"] = "Только уведомление"
	L["Show Full Duration"] = "Показывать полную длительность"
	L["LoseControl reset."] = "Сброс настроек LoseControl."
